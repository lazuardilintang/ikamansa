...
<form action="" method="post">
  ...
  <div class="form-group">
    ...
    <textarea style="resize:none;width:100%;height:300px;" class="form-control" name="2019"></textarea> 	
  ...
  <div class="form-group">
    ...
    <textarea style="resize:none;width:100%;height:300px;" class="form-control" name="2020"></textarea>
    <small id="nama" class="form-text text-muted">isi dengan jelas dan jangan disingkat</small>	
  </div>
  <div class="form-group">
    <label for="url">masukan URL website resmi kampus</label>
    <input type="text" name="url" class="form-control" id="url" aria-describedby="nama">
  ...
  <div class="form-group">
    ...
    <input type="text" name="urlig" class="form-control" id="url" aria-describedby="nama">
  ...
  <button type="submit" name="sebar" class="btn btn-warning">sebarkan</button>
</form>	
</div>
</body>
</html>
...
if (isset($_POST['sebar'])) {
  header("location:../baik/daftar");
}
 ?>