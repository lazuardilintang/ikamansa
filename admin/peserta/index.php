...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.min.js" integrity="sha384-w1Q4orYjBQndcko6MimVbzY0tgp4pWB4lZ7lr30WKz0vr/aWKhXdBNmNb5D92v7s" crossorigin="anonymous"></script>
 ...
 <body>
<?php 
$hitung = mysqli_num_rows(mysqli_query($koneksi,"SELECT *FROM formulir"));?>
 <div class="container-fluid my-5">
  <div class="row">
    ...
    <div class="col-sm p-2">
      <div class="d-flex justify-content-center" >
        <a href="../"><button type="button" class="mx-2 btn btn-primary">Menu Utama</button></a>
...
<table id="tampil" class="table">
  ...
  <?php 
	...
	$data_pegawai = mysqli_query($koneksi,"SELECT * from formulir order by id desc limit $halaman_awal, $batas");
	...
	?>
  	<tbody id="tampilkan">
            ...
            <td><a href="<?php echo $d['url'] ?>"><img src="../../gambar/instagram.svg" style=" box-sizing: border-box; width: 40px; margin: 2px;"></a></td>
            <td><img width="100px" src="../../bukti/<?php echo $d['gambar'] ?>"></td>
						<td>
